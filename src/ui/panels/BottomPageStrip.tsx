...
export const BottomPageStrip: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full h-16 bg-slate-950 border-t border-slate-800 flex items-center justify-between px-4 gap-4 select-none z-20 flex-shrink-0 backdrop-blur-sm print:hidden">
